...
// Fetch random movies
$randomMovies = $conn->query("SELECT * FROM  movies WHERE type='1'")->fetch_all(MYSQLI_ASSOC);
$allGenre = $conn->query("SELECT DISTINCT genre FROM movies WHERE type='1'")->fetch_all(MYSQLI_ASSOC);
?>
<!DOCTYPE html>
<html lang="en">
    ...
    <footer>
        <div class="wrapper">
            <div class="links-container">
                ...
                <p class="copyright"> © Copyright 2024. All Rights Reserved. Rateflix Pragesh&Mausam </p>
            </div>
        </div>
    </footer>
